...
class Configuration(ExceptionDefault):
    ...
    def __init__(self) -> NoReturn:
        self._envs = {"NAMESPACE": self._get_env_value("NAMESPACE"),
                        "ALL_NAMESPACES": self._get_env_value("ALL_NAMESPACES"),
                        "KUBECONFIG": self._get_env_value("KUBECONFIG"),
                        "HELM_RELEASE_FILTER_DAYS": self._get_env_value("HELM_RELEASE_FILTER_DAYS"),
